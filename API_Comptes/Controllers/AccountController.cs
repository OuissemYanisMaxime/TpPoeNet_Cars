...
using API_Comptes.Providers;
using API_Comptes.Results;
using DAO.modeles;
...
namespace API_Comptes.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // POST api/Account/Register/Prestataire
        [AllowAnonymous]
        [Route("Register/Prestataire")]
        public async Task<IHttpActionResult> RegisterPrestataire(RegisterPrestataireBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
